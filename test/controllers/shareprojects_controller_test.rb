...
class ShareprojectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shareproject" do
    assert_difference('Shareproject.count') do
      post shareprojects_url, params: { shareproject: { comment: @shareproject.comment, creator: @shareproject.creator, description: @shareproject.description, feature_url: @shareproject.feature_url, name: @shareproject.name } }, as: :json
    end
  ...
  test "should update shareproject" do
    patch shareproject_url(@shareproject), params: { shareproject: { comment: @shareproject.comment, creator: @shareproject.creator, description: @shareproject.description, feature_url: @shareproject.feature_url, name: @shareproject.name } }, as: :json
    assert_response 200
  end
